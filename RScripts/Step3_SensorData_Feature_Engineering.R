# Seperately extract this part to work with python script
# This takes input from command line (python invoked)
# Use to generate data with differetn window size 
